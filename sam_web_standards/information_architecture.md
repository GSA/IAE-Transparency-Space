...
Grouping content and metadata separately allows a front-end user to quickly discern the *content* of a page from the information *about* the content of a page depending on which you, as a front-end user, am interested in. Further, content and metadata should also be ordered, as much as possible, in a way that gives a front-end user what they are most concerned about first, with the details later. 
